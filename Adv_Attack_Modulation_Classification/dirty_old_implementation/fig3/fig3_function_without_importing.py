# I see that as rnd increases the time for calculating fgm increases
# so i said maybe it has something to do with importing the fgm and now this file has fgm in it
...
def acc_psr_fun(PSR,SNR,num_times,N):
    ...
    print('No importing - fgm attack is inside the func, otherwise will be 10 times slower')
